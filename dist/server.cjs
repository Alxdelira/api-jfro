...
app_default.use("/docs", import_swagger_ui_express.default.serve, import_swagger_ui_express.default.setup(swaggerSpec, { swaggerOptions: { url: "/docs/swagger.json" }, customCss: CSS_URL }));
