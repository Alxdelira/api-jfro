...
var InventarioRouter_exports = {};
__export(InventarioRouter_exports, {
  default: () => InventarioRouter_default
});
module.exports = __toCommonJS(InventarioRouter_exports);
...
router.post("/inventario", InventarioController.criarInventario).get("/inventario", InventarioController.listarInventarios).get("/inventario/:id", InventarioController.buscarInventario).patch("/inventario/:id", InventarioController.atualizarInventario).delete("/inventario/:id", InventarioController.deletarInventario);
var InventarioRouter_default = router;
